...
export const evmWalletProvider: Provider = {
    async get(
        ...
        try {
            ...
            // Obtenim el valor de EVM_PUBLIC_ADDRESS des de les configuracions/variables d'entorn
            const publicAddress = runtime.getSetting("EVM_PUBLIC_ADDRESS");
            
            // Construïm la resposta afegint el publicAddress si està definit
            let result = `${agentName}'s EVM Wallet Address: ${address}`;
            if (publicAddress) {
